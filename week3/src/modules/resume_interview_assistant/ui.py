"""Streamlit UI for Resume Screening & Interview Assistant (Hammad Abbas)."""

import streamlit as st
from src.modules.registry import MODULE_REGISTRY
from src.modules.resume_interview_assistant.engine import ResumeInterviewAssistantEngineStub


def render_ui() -> None:
    """Render scaffolding screen for Hammad Abbas's module."""
    metadata = MODULE_REGISTRY["week3"]["resume_interview_assistant"]
    stub = ResumeInterviewAssistantEngineStub()
    info = stub.get_info()
